...
describe Apiary::Honey::Parser do
  
  let(:lexer) { Apiary::Honey::Lexer.new }
  let(:parser) { Apiary::Honey::Parser.new }
  ...
  it "raises an error when it encounters an unparsable statement" do
    ...
    expect { parser.parse nodes }.to raise_error(Apiary::Honey::ParseError)
  end
  ...
  describe "EQ statement" do
    ...
    it "raises an exception when the right-side argument isn't a field/identifier" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /left-side argument can only be of types field, identifier/i)
    end

    it "raises an exception when no field is provided" do
      nodes = lexer.tokenize %q{eq 20}

      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /field name required/i)
    end

    it "raises an exception when no arguments are provided" do
      nodes = lexer.tokenize %q{role_id eq}

      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /At least 1 argument required/i)
    end

    it "raises an exception when too many arguments are provided" do
      nodes = lexer.tokenize %q{role_id eq 20 42}

      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /no more than 1 argument allowed/i)
    end

    it "raises an exception when the arguments are of the wrong type" do
      nodes = lexer.tokenize %q{role_id eq foo}

      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /only decimal, integer, null, string arguments are allowed/i)
    end
  end
  ...
  describe "GT statement" do
    ...
    it "raises an exception when the arguments are of the wrong type" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /only decimal, integer arguments are allowed/i)
    end
  end
  ...
  describe "LIKE statement" do
    ...
    it "raises an exception when the arguments are of the wrong type" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /only string arguments are allowed/i)
    end
  end
  ...
  describe "PAGE statement" do
    ...
    it "raises an exception when the arguments are of the wrong type" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /only integer arguments are allowed/i)
    end
  end
  ...
  describe "PAGE_SIZE statement" do
    ...
    it "only accepts table names, not fields" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /Left-side argument can only be of type IDENTIFIER/)
    end
  ...
  describe "SORT statement" do
    ...
    it "raises an exception when the arguments are of the wrong type" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /only direction arguments are allowed/i)
    end
  end
  ...
  describe "INCLUDES statement" do
    ...
    it "raises an exception when the arguments are of the wrong type" do
      ...
      expect { parser.parse nodes }.to raise_exception(Apiary::Honey::ParseError, /only identifier arguments are allowed/i)
    end
  end
